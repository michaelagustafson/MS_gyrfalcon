...
write.csv(state_summary, "E:/gyrf_analysis/squirrel_state_summary.csv")
write.csv(det_summary, "E:/gyrf_analysis/squirrel_det_summary.csv")
write.csv(state_confint, "E:/gyrf_analysis/squirrel_state_confint.csv")
write.csv(det_confint, "E:/gyrf_analysis/squirrel_det_confint.csv")
```
...
plot(time.prediction, axes = FALSE, col=colorRampPalette(brewer.pal(3,"Reds"))(100))
