...
all.mos <- raster(here("jenny/all.mos.dem.tif"))
...
pts <- as.data.frame(readOGR(here("shapefiles"), "pts_3years_2"))

```


## Study Area NEED TO UPDATE AFTER GETTING OCCUPANCY DATA

```{r studyarea}
study.area <- readOGR(here("shapefiles"), "gyrf_studyarea")
crs(study.area)
