...
#mask with dem.1k
lc_stack2 <- resample(lc_stack2, dem.1k, method = 'ngb') #NOT SURE WHY I DIDN'T DO THIS HERE? Earlier it was hashed out..
#lc_stack2 <- mask(lc_stack2, dem.1k)
...
write.csv(pland2, "E:/gyrf_analysis/MSgyrfalcon/MSgyrfalcon/pland2_400r.csv")
