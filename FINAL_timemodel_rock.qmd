...
write.csv(state_summary, "E:/gyrf_analysis/rock_state_summary.csv")
write.csv(det_summary, "E:/gyrf_analysis/rock_det_summary.csv")
write.csv(state_confint, "E:/gyrf_analysis/rock_state_confint.csv")
write.csv(det_confint, "E:/gyrf_analysis/rock_det_confint.csv")
```
...
ggsave("E:/gyrf_analysis/FINAL time pprediction plots 17Nov23/ropt_tundra.png", width = 20, height = 15, dpi = 300, limitsize = FALSE)
```
...
ggsave("E:/gyrf_analysis/FINAL time pprediction plots 17Nov23/ropt_lowshrub.png", width = 20, height = 15, dpi = 300, limitsize = FALSE)
```
...
ggsave("E:/gyrf_analysis/FINAL time pprediction plots 17Nov23/ropt_sparseveg.png", width = 20, height = 15, dpi = 300, limitsize = FALSE)
```
...
ggsave("E:/gyrf_analysis/FINAL time pprediction plots 17Nov23/ropt_elevation.png", width = 20, height = 15, dpi = 300, limitsize = FALSE)
```
...
ggsave("E:/gyrf_analysis/detection partial plots 20nov23/rock_observer.png", width = 15, height = 15, dpi = 300)
```
...
ggsave("E:/gyrf_analysis/detection partial plots 20nov23/rock_julian.png", width = 15, height = 15, dpi = 300)
```
...
ggsave("E:/gyrf_analysis/detection partial plots 20nov23/rock_wind.png", width = 15, height = 15, dpi = 300)
```
...
ggsave("E:/gyrf_analysis/detection partial plots 20nov23/rock_minsun.png", width = 15, height = 15, dpi = 300)
```
