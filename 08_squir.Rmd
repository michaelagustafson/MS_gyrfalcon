...
lc.vars <- read.csv("E:/gyrf_analysis/gyrf3/output/data_pts_17Aug.csv") #these are the land cover characteristics and elevation we extracted in the previous code 

site.vars <- read.csv(here("E:/gyrf_analysis/gyrf3/output/env_3years.csv")) #these are the data collected at the beginning of each survey (temp, wind, etc.)
