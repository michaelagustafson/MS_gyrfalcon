...
abundData <- data.frame( tundra = 0, tussock = 0, tallshrub = 0, elev = elev.std, area = area.x )
...
#view
w.elevp
ggsave("E:/gyrf_analysis/partial prediction plots 1nov23/wipt_elev_nb_tallshrubonly.png", width = 20, height = 15, dpi = 300)
...
#combine standardized predictors into a new dataframe to predict partial relationship
# for abundance submodel:
abundData <- data.frame( tundra = 0, tussock = tussock.std, tallshrub = 0, elev = 0, area = area.x )
...
#view
w.tussp
ggsave("E:/gyrf_analysis/partial prediction plots 1nov23/wipt_tussock_nb_tallshrubonly.png", width = 20, height = 15, dpi = 300, limitsize = FALSE)
